...
class CartActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        checkoutButton.setOnClickListener {
            if (validateAddress() && databaseReference !=null ) {
                ...
                val dateInString = date.toString("HH:mm:ss dd/MM/yyyy")
                saveBillToDatabase(username.toString(),dateInString)
    ...
    private fun saveBillToDatabase(username: String, dateInString:String) {
